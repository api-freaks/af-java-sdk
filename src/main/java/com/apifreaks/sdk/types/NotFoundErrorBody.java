...
public final class NotFoundErrorBody {
  ...
  private NotFoundErrorBody(Optional<String> timestamp, Optional<Integer> status,
  ...
  public static final class Builder {
    ...
    public NotFoundErrorBody build() {
      return new NotFoundErrorBody(timestamp, status, error, message, path, additionalProperties);
    }
