...
public final class ForbiddenErrorBody {
  ...
  private ForbiddenErrorBody(Optional<String> timestamp, Optional<Integer> status,
  ...
  public static final class Builder {
    ...
    public ForbiddenErrorBody build() {
      return new ForbiddenErrorBody(timestamp, status, error, message, path, additionalProperties);
    }
