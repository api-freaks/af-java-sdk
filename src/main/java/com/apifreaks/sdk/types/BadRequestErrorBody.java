...
public final class BadRequestErrorBody {
  ...
  private BadRequestErrorBody(Optional<String> timestamp, Optional<Integer> status,
  ...
  public static final class Builder {
    ...
    public BadRequestErrorBody build() {
      return new BadRequestErrorBody(timestamp, status, error, message, path, additionalProperties);
    }
