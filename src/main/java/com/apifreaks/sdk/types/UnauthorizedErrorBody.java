...
public final class UnauthorizedErrorBody {
  ...
  private UnauthorizedErrorBody(Optional<String> timestamp, Optional<Integer> status,
  ...
  public static final class Builder {
    ...
    public UnauthorizedErrorBody build() {
      return new UnauthorizedErrorBody(timestamp, status, error, message, path, additionalProperties);
    }
