...
@JsonDeserialize(
    builder = GatewayTimeoutErrorBody.Builder.class
)
public final class GatewayTimeoutErrorBody {
  ...
  private GatewayTimeoutErrorBody(Optional<String> timestamp, Optional<Integer> status,
  ...
  public static final class Builder {
    ...
    public GatewayTimeoutErrorBody build() {
      return new GatewayTimeoutErrorBody(timestamp, status, error, message, path, additionalProperties);
    }
