...
@JsonDeserialize(
    builder = ZipcodeLookupResponseResultsItem.Builder.class
)
public final class ZipcodeLookupResponseResultsItem {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ZipcodeLookupResponseResultsItem && equalTo((ZipcodeLookupResponseResultsItem) other);
  }
  ...
  public static final class Builder {
    ...
    public Builder from(ZipcodeLookupResponseResultsItem other) {
      code(other.getCode());
