...
public final class TooManyRequestsErrorBody {
  ...
  private TooManyRequestsErrorBody(Optional<String> timestamp, Optional<Integer> status,
  ...
  public static final class Builder {
    ...
    public TooManyRequestsErrorBody build() {
      return new TooManyRequestsErrorBody(timestamp, status, error, message, path, additionalProperties);
    }
